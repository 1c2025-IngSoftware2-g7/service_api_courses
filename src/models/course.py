...
class Course:
    def __init__(self, course_name: str, course_description: str, max_students: int, course_start_date: str, course_end_date: str, creator_id: str, creator_name: str, students: list = None, _id: ObjectId = None, resources: list = None, enroll_date_start: datetime = datetime.now(), enroll_date_end: str = None): 
        ...
        self.enroll_date_end = datetime.strptime(enroll_date_end, "%Y-%m-%d") if enroll_date_end else None
