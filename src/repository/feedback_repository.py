...
class FeedBackRepository:
    def __init__(self, collection_courses_feedback, collection_students_feedback, logger):
    ...
    def get_course_feedback(self, course_id):
        ...
        """
        feedback_result = self.collection_courses_feedback.find({"course_id": course_id})
    ...
    def get_student_feedback(self, student_id, course_id):
        ...
        """
        feedback_result = self.collection_students_feedback.find({"student_id": student_id, "course_id": course_id})
