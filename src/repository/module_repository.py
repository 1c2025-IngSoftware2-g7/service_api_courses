...
class ModuleRepository:
    def __init__(self, collection_modules_and_resources, logger):
    ...
    def get_modules_from_course(self, course_id):
        ...
        """
        modules = list(self.collection_modules.find({"course_id": course_id}))

        self.logger.debug(
            f"[REPOSITORY] Retrieved modules for course with ID: {course_id}"
        )
